...
my %frameReadings = (
 ...
 # Disabled because unsure if they are correct:
 ...
 'Temp-Verdampfer-Min'      => { addr => 0x010C, bytes => 0x004, fmat => '%0.1f', unp => 'f<' },
 'AnalogKorrFaktor'         => { addr => 0x0116, bytes => 0x004, fmat => '%0.4f', unp => 'f<', min => 1.000, max => 1.999 },
 ...
 'Unterdr-Warn-Eingang'     => { addr => 0x0FA, bytes => 0x001, unp => 'B8' },
 'Unterdr-Warn-Ausgang'     => { addr => 0x0FB, bytes => 0x001, unp => 'B8' },
 'Unterdr-Warn-Sonstige'    => { addr => 0x0FC, bytes => 0x001, unp => 'B8' },
